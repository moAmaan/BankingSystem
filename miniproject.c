...
printf("\t\t\4\t\t\t\t\t\t\4\n");
printf("\t\t\4\t\t\t\t\t\t\4\n");
printf("\t\t\4\tWELCOME TO OUR APNA BANK BANKING SYSTEM\t\t\4\n");
printf("\t\t\4\t\t\t\t\t\t\4\n");
printf("\t\t\4\t\t\t\t\t\t\4\n");
printf("\t\t\4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4\n");
...
printf("\n\t\t\t    ---------------------------");
printf("\n\t\t\t\tAPNA BANK BANK LIMITED\n");
printf("\t\t\t    ---------------------------\n\n");
printf("\t\t\tDate:09/11/2020\t   Time:10:20 Am\n");
printf("\n\t\t\t\4 Your name: %s\n\n",name);
...
printf("\n\t\t\t\t    Thank you! \n");
printf("\t\t\t   Welcome to APNA BANK Banking System\n");
printf("\t\t\t      www.APNABANKBANKINGSYSTEM.com\n");
printf("\n\n\t\tPROJECT MADE BY:-MOHD. AMAAN KHAN\n\t\t***************\n\n\t\tSECTION:- D\n\t\t********\n\n\t\tUNIVERSITY :- GRAPHIC ERA UNIVERSITY\n\t\t***********\n\n\t\tUNIVERSITY ROLLNO:-2014729\n\t\t********************\n\n\n");
getch();
return(0);
}